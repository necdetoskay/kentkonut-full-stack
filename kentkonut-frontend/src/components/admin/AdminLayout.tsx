...
export function AdminLayout() {
  ...
  // Debug: Log navigation items and location
  React.useEffect(() => {
    console.log('Current location:', location.pathname);
    console.log('Navigation items:', navigation);
  }, [location]);

  // Debug: Check if navigation is being filtered
  const filteredNavigation = React.useMemo(() => {
    console.log('Filtering navigation items');
    return navigation;
  }, [navigation]);
  
  // Debug: Add a very visible debug indicator
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 relative">
      {/* Debug banner - only visible in development */}
