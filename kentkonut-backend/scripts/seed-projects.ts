/*
  Seed 10 completed and 5 in-progress projects with meaningful content and non-empty images.
  - Uses Media entries pointing to via.placeholder.com (allowed in next.config.mjs)
...
async function ensureMedia(url: string, idx: number) {
...
function projectHtml(name: string): string {
...
main()
  .then(async () => {
    console.log('🎉 Seeded 10 completed + 5 in-progress projects.');
