  ...
  const executives = [
    {
      ...
      content: '<p>Dr. Mehmet Özkan, kentsel dönüşüm ve hafriyat yönetimi alanında 25 yıllık deneyime sahip uzman bir mühendistir.</p><p>Uzmanlık alanları:</p><ul><li>Kentsel dönüşüm projeleri</li><li>Hafriyat yönetimi</li><li>Kentsel planlama</li><li>Proje yönetimi</li></ul>',
    ...
    },
    {
      ...
      content: '<p>Mimar Ayşe Demir, şehir plancılığı ve mimarlık alanında 20 yıllık deneyime sahiptir.</p><p>Uzmanlık alanları:</p><ul><li>Şehir plancılığı</li><li>Kentsel tasarım</li><li>Sürdürülebilir kalkınma</li><li>Mimari proje yönetimi</li></ul>',
    ...
    },
    {
      ...
      content: '<p>İnşaat Mühendisi Hasan Kaya, hafriyat ve altyapı projeleri konusunda 18 yıllık deneyime sahiptir.</p><p>Uzmanlık alanları:</p><ul><li>Hafriyat projeleri</li><li>Altyapı planlama</li><li>Proje yönetimi</li><li>Teknik denetim</li></ul>',
    ...
    },
    {
      ...
      content: '<p>Çevre Mühendisi Fatma Yılmaz, çevre koruma ve sürdürülebilir kalkınma alanında 15 yıllık deneyime sahiptir.</p><p>Uzmanlık alanları:</p><ul><li>Çevre koruma</li><li>Sürdürülebilir kalkınma</li><li>Çevre dostu teknolojiler</li><li>Çevre etki değerlendirmesi</li></ul>',
