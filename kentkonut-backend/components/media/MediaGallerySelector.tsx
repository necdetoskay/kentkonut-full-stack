...
export function MediaGallerySelector({ 
  ...
  const handleDeleteSelected = async (): Promise<void> => {
    ...
    try {
      ...
      const deletePromises = selectedForAction.map(async (fileId): Promise<string | null> => {
        try {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              onBlur={() => {
                                // Alt text değişikliği kaydedildi
                                console.log(`Alt text updated for ${item.originalName}: ${item.alt}`);
                              }}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onBlur={() => {
                                // Caption değişikliği kaydedildi
                                console.log(`Caption updated for ${item.originalName}: ${item.caption}`);
                              }}
