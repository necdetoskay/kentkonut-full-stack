  ...
  return (
    <div className="p-6">      <Breadcrumb
        segments={[
          ...
          { name: department.name, href: `/dashboard/corporate/departments/${resolvedParams.id}` },
        ]}
        className="mb-4"
      />
            ...
            <CardContent className="pt-6">
              <div className="flex justify-between mb-6">
                <h3 className="text-xl font-semibold">Birim Personeli</h3>                <Button 
                  onClick={() => router.push(`/dashboard/corporate/departments/new-personnel?departmentId=${resolvedParams.id}`)}
                >
                ...
                {department.director ? (
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex space-x-2">
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => router.push(`/dashboard/corporate/personnel/${department.director?.id}/edit`)}
                          >
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-md p-4 text-center">
                    <p className="text-gray-500">Bu birime atanmış müdür bulunmamaktadır</p>                    <Button
                      ...
                      size="sm"
                      className="mt-2"
                      onClick={() => router.push(`/dashboard/corporate/departments/new-personnel?departmentId=${resolvedParams.id}&type=DIRECTOR`)}
                    >
                      <Users className="h-4 w-4 mr-2" />
                      Müdür Ata
                    </Button>
                ...
                {department.chiefs && department.chiefs.length > 0 ? (
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="flex space-x-2">
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => router.push(`/dashboard/corporate/personnel/${chief.id}/edit`)}
                              >
                                <svg className="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-md p-4 text-center">
                    <p className="text-gray-500">Bu birime atanmış şef bulunmamaktadır</p>                    <Button
                      ...
                      size="sm"
                      className="mt-2"
                      onClick={() => router.push(`/dashboard/corporate/departments/new-personnel?departmentId=${resolvedParams.id}&type=CHIEF`)}
                    >
                      <Users className="h-4 w-4 mr-2" />
                      Şef Ekle
                    </Button>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex justify-between mb-6">
                ...
                <Button onClick={() => router.push(`/dashboard/corporate/department-quick-links?departmentId=${resolvedParams.id}`)}>
