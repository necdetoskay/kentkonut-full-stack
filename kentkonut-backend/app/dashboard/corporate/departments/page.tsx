...
export default function DepartmentsPage() {
  ...
  const navigateToCreateDepartment = () => {
    router.push('/dashboard/corporate/departments/new')
  }
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-end mb-4">
        <Button onClick={() => router.push('/dashboard/corporate/departments/new')}>
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex space-x-1">                        <Button 
                          variant="ghost" 
                          size="sm"
                          onClick={() => router.push(`/dashboard/corporate/departments/${department.id}`)}
                        >
