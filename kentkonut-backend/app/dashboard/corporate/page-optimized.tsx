...
export default function CorporatePage() {
  ...
  const modules = [
    ...
    },
    {
      ...
      description: "Vizyon, misyon ve kurumsal değerleri yönetin",
      icon: Target,
      href: "/dashboard/corporate/content",
      color: "bg-indigo-500",
      stats: [
        { label: "İçerik", value: "4" },
        { label: "Son Güncelleme", value: "2 gün önce" }
      ],
      features: ["Vizyon & Misyon", "Kurumsal değerler", "Strateji", "Hedefler"],
      isComingSoon: false
    },
    {
        ...
        <div className="mt-12">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Button 
              variant="outline" 
              className="h-20 flex-col gap-2"
              onClick={() => router.push('/dashboard/corporate/content')}
            >
