...
import { BannerGroupFormData, BANNER_POSITION_OPTIONS } from '@/types'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(data.error || 'Banner grubu oluşturulurken hata oluştu')
      }
    } catch (error) {
      console.error('❌ Submit error:', error)
      alert('Banner grubu oluşturulurken hata oluştu')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="container mx-auto p-6">
      ...
      <Breadcrumb 
        segments={[
          ...
          { name: 'Yeni Banner Grubu', href: '/dashboard/banner-groups/new' }
        ]}
        className="mb-6"
      />
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-3xl font-bold">Yeni Banner Grubu</h1>
      </div>
