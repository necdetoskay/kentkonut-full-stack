  ...
  const renderTextFields = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="mt-2">          <RichTextEditor
        ...
        <p className="text-sm text-gray-500 mt-2">
          TipTap editör ile içeriğinizi biçimlendirebilirsiniz. Resim ekleme, floating resimler, hizalama, boyutlandırma ve HTML düzenleme özelliklerini kullanabilirsiniz.
        </p>
      </div>
    </div>
  );
